...
const int ToneDemodSettings::m_rfBWMin = 10000;
const int ToneDemodSettings::m_rfBWMax = 300000;
const int ToneDemodSettings::m_rfBWDigits = 6;

int m_tone = 0;

ToneDemodSettings::ToneDemodSettings() :
...
void ToneDemodSettings::resetToDefaults()
{
...
QByteArray ToneDemodSettings::serialize() const
{
...
bool ToneDemodSettings::deserialize(const QByteArray& data)
{
	...
	if (d.getVersion() == 1)
	{
		...
		d.readString(8, &m_title, "Tone Demodulator");
...
int ToneDemodSettings::getTone() {
	return m_tone;
}

void ToneDemodSettings::setTone(int tone) {
	m_tone = tone;
}