...
#ifndef INCLUDE_TONEDEMODBASEBAND_H
#define INCLUDE_TONEDEMODBASEBAND_H
...
class ToneDemodBaseband : public QObject
{
	Q_OBJECT
public:
	...
	public:
		...
		static MsgConfigureWFMDemodBaseband* create(const ToneDemodSettings& settings, bool force)
		{
	...
	private:
		...
		MsgConfigureWFMDemodBaseband(const ToneDemodSettings& settings, bool force) :
			Message(),
			m_settings(settings),
			m_force(force)
		{
...
#endif // INCLUDE_TONEDEMODBASEBAND_H
