...
///////////////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDE_CWDEMODGUI_H
#define INCLUDE_CWDEMODGUI_H
...
class CWDemodGUI : public ChannelGUI {
	Q_OBJECT

public:
	static CWDemodGUI* create(PluginAPI* pluginAPI, DeviceUISet *deviceUISet, BasebandSampleSink *rxChannel);
...
private:
	...
	explicit CWDemodGUI(PluginAPI* pluginAPI, DeviceUISet* deviceUISet, BasebandSampleSink *rxChannel, QWidget* parent = 0);
	virtual ~CWDemodGUI();
