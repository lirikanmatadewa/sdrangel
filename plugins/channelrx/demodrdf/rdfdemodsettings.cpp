...
const int RDFDemodSettings::m_rfBWMin = 10000;
const int RDFDemodSettings::m_rfBWMax = 300000;
const int RDFDemodSettings::m_rfBWDigits = 6;

RDFDemodSettings::RDFDemodSettings() :
...
void RDFDemodSettings::resetToDefaults()
{
...
QByteArray RDFDemodSettings::serialize() const
{
...
bool RDFDemodSettings::deserialize(const QByteArray& data)
{
    ...
    if(d.getVersion() == 1)
    {
        ...
        d.readString(8, &m_title, "RDF Demodulator");
