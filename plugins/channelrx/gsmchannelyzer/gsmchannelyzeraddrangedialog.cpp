...
#include "ui_gsmchannelyzeraddrangedialog.h"

GsmChannelyzerAddRangeDialog::GsmChannelyzerAddRangeDialog(int step, QWidget* parent) :
    QDialog(parent),
    ui(new Ui::GsmChannelyzerAddRangeDialog)
{
    (void) step;
...
GsmChannelyzerAddRangeDialog::~GsmChannelyzerAddRangeDialog()
{
    delete ui;
}

void GsmChannelyzerAddRangeDialog::accept()
{
...
void GsmChannelyzerAddRangeDialog::on_preset_currentTextChanged(const QString& text)
{
