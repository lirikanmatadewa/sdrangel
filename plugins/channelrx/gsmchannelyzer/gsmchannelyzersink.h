...
#ifndef INCLUDE_GSMCHANNELYZERSINK_H
#define INCLUDE_GSMCHANNELYZERSINK_H
...
class GsmChannelyzerSink : public ChannelSampleSink {
public:
    GsmChannelyzerSink(GsmChannelyzer *packetDemod);
    ~GsmChannelyzerSink();
...
#endif // INCLUDE_GSMCHANNELYZERSINK_H
