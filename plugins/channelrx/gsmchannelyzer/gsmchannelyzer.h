...
#ifndef INCLUDE_GSMCHANNELYZER_H
#define INCLUDE_GSMCHANNELYZER_H
...
class GsmChannelyzer : public BasebandSampleSink, public ChannelAPI {
public:
    class MsgConfigureGsmChannelyzer : public Message {
        MESSAGE_CLASS_DECLARATION

    public:
        const GsmChannelyzerSettings& getSettings() const { return m_settings; }
        const QStringList& getSettingsKeys() const { return m_settingsKeys; }
        bool getForce() const { return m_force; }

        static MsgConfigureGsmChannelyzer* create(const GsmChannelyzerSettings& settings, const QStringList& settingsKeys, bool force)
        {
            return new MsgConfigureGsmChannelyzer(settings, settingsKeys, force);
        }

    private:
        GsmChannelyzerSettings m_settings;
        QStringList m_settingsKeys;
        bool m_force;

        MsgConfigureGsmChannelyzer(const GsmChannelyzerSettings& settings, const QStringList& settingsKeys, bool force) :
            Message(),
            m_settings(settings),
    ...
    GsmChannelyzer(DeviceAPI *deviceAPI);
    virtual ~GsmChannelyzer();
    ...
    static void muteAll(const GsmChannelyzerSettings& settings);
...
private:
    ...
    QThread *m_thread;
    GsmChannelyzerBaseband* m_basebandSink;
    ...
    void applySettings(const GsmChannelyzerSettings& settings, const QStringList& settingsKeys, bool force = false);
    void webapiReverseSendSettings(const QStringList& channelSettingsKeys, const GsmChannelyzerSettings& settings, bool force);
    ...
    static QList<SWGSDRangel::SWGFreqScannerFrequency *> *createFrequencyList(const GsmChannelyzerSettings& settings);
...
#endif // INCLUDE_GSMCHANNELYZER_H
