...
#ifndef INCLUDE_GSMCHANNELYZERSETTINGS_H
#define INCLUDE_GSMCHANNELYZERSETTINGS_H
...
struct GsmChannelyzerSettings
{
    ...
    GsmChannelyzerSettings();
    void resetToDefaults();
    void setChannelMarker(Serializable *channelMarker) { m_channelMarker = channelMarker; }
    void setRollupState(Serializable *rollupState) { m_rollupState = rollupState; }
    QByteArray serialize() const;
    bool deserialize(const QByteArray& data);
    void applySettings(const QStringList& settingsKeys, const GsmChannelyzerSettings& settings);
    QString getDebugString(const QStringList& settingsKeys, bool force = false) const;
    QString getChannel(GsmChannelyzerSettings::FrequencySettings *frequencySettings) const;
    Real getThreshold(GsmChannelyzerSettings::FrequencySettings *frequencySettings) const;
    int getChannelBandwidth(GsmChannelyzerSettings::FrequencySettings *frequencySettings) const;
    GsmChannelyzerSettings::FrequencySettings *getFrequencySettings(qint64 frequency);
};

#endif /* INCLUDE_GSMCHANNELYZERSETTINGS_H */
