...
#include "gsmchannelyzersettings.h"

GsmChannelyzerSettings::GsmChannelyzerSettings() :
    m_channelMarker(nullptr),
    m_rollupState(nullptr)
{
    for (int i = 0; i < GSMCHANNELYZER_COLUMNS; i++)
    {
...
void GsmChannelyzerSettings::resetToDefaults()
{
...
QByteArray GsmChannelyzerSettings::serialize() const
{
...
bool GsmChannelyzerSettings::deserialize(const QByteArray& data)
{
    ...
    if(d.getVersion() == 1)
    {
        ...
        d.readString(41, &m_title, "GSM Channelyzer");
        if (m_channelMarker)
        {
...
void GsmChannelyzerSettings::applySettings(const QStringList& settingsKeys, const GsmChannelyzerSettings& settings)
{
...
QString GsmChannelyzerSettings::getDebugString(const QStringList& settingsKeys, bool force) const
{
...
QByteArray GsmChannelyzerSettings::FrequencySettings::serialize() const
{
    SimpleSerializer s(1);
...
bool GsmChannelyzerSettings::FrequencySettings::deserialize(const QByteArray& data)
{
    SimpleDeserializer d(data);
...
QDataStream& operator<<(QDataStream& out, const GsmChannelyzerSettings::FrequencySettings& settings)
{
    out << settings.serialize();
    return out;
}

QDataStream& operator>>(QDataStream& in, GsmChannelyzerSettings::FrequencySettings& settings)
{
    QByteArray data;
    in >> data;
...
QString GsmChannelyzerSettings::getChannel(GsmChannelyzerSettings::FrequencySettings *frequencySettings) const
{
...
Real GsmChannelyzerSettings::getThreshold(GsmChannelyzerSettings::FrequencySettings *frequencySettings) const
{
    ...
    if (!frequencySettings->m_threshold.isEmpty())
    {
        ...
        if (ok) {
            ...
            qDebug() << "GsmChannelyzerSettings::getThreshold: Failed to parse" << frequencySettings->m_threshold << "as a float";
        }
    }
    return threshold;
}

int GsmChannelyzerSettings::getChannelBandwidth(GsmChannelyzerSettings::FrequencySettings *frequencySettings) const
{
    ...
    if (!frequencySettings->m_channelBandwidth.isEmpty())
    {
        ...
        if (ok) {
            ...
            qDebug() << "GsmChannelyzerSettings::getChannelBandwidth: Failed to parse" << frequencySettings->m_channelBandwidth << "as an int";
        }
    }
    return channelBandwidth;
}

GsmChannelyzerSettings::FrequencySettings *GsmChannelyzerSettings::getFrequencySettings(qint64 frequency)
{
