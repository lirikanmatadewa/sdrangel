...
#include "ui_widebandscanneraddrangedialog.h"

WidebandScannerAddRangeDialog::WidebandScannerAddRangeDialog(int step, QWidget* parent) :
    QDialog(parent),
    ui(new Ui::WidebandScannerAddRangeDialog)
{
    (void) step;
...
WidebandScannerAddRangeDialog::~WidebandScannerAddRangeDialog()
{
    delete ui;
}

void WidebandScannerAddRangeDialog::accept()
{
...
void WidebandScannerAddRangeDialog::on_preset_currentTextChanged(const QString& text)
{
