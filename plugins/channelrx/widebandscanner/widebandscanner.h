...
#ifndef INCLUDE_WIDEBANDSCANNER_H
#define INCLUDE_WIDEBANDSCANNER_H
...
class WidebandScanner : public BasebandSampleSink, public ChannelAPI {
public:
    class MsgConfigureWidebandScanner : public Message {
        MESSAGE_CLASS_DECLARATION

    public:
        const WidebandScannerSettings& getSettings() const { return m_settings; }
        const QStringList& getSettingsKeys() const { return m_settingsKeys; }
        bool getForce() const { return m_force; }

        static MsgConfigureWidebandScanner* create(const WidebandScannerSettings& settings, const QStringList& settingsKeys, bool force)
        {
            return new MsgConfigureWidebandScanner(settings, settingsKeys, force);
        }
    ...
    private:
        ...
        MsgConfigureWidebandScanner(const WidebandScannerSettings& settings, const QStringList& settingsKeys, bool force) :
            Message(),
            m_settings(settings),
    ...
    WidebandScanner(DeviceAPI *deviceAPI);
    virtual ~WidebandScanner();
    ...
    static void muteAll(const WidebandScannerSettings& settings);
...
private:
    ...
    QThread *m_thread;
    WidebandScannerBaseband* m_basebandSink;
    ...
    void applySettings(const WidebandScannerSettings& settings, const QStringList& settingsKeys, bool force = false);
    void webapiReverseSendSettings(const QStringList& channelSettingsKeys, const WidebandScannerSettings& settings, bool force);
    ...
    static QList<SWGSDRangel::SWGFreqScannerFrequency *> *createFrequencyList(const WidebandScannerSettings& settings);
...
#endif // INCLUDE_WIDEBANDSCANNER_H
