...
#ifndef SWGRDFModSettings_H_
#define SWGRDFModSettings_H_
...
class SWG_API SWGRDFModSettings: public SWGObject {
public:
    SWGRDFModSettings();
    SWGRDFModSettings(QString* json);
    virtual ~SWGRDFModSettings();
    void init();
    void cleanup();
    ...
    virtual SWGRDFModSettings* fromJson(QString &jsonString) override;
